...
public class SDKUtil {
    ...
    public void initSDK(String appid, String appkey) {
        Tracking.initWithKeyAndChannelId(context, appid, appkey);
                ...
                switch (code) {
                    ...
                    case FreeCallbackCode.LOGIN_SUCCESS:
                        ...
                        try {
                            ...
                            //热云登录上传账户
                            Tracking.setRegisterWithAccountID(account_id);
                            Tracking.setLoginSuccessBusiness(account_id);
                    ...
                    case FreeCallbackCode.PAY_SUCCESS:
                        if (null != freeOrder) {
                            ...
                            //热云支付统计
                            Tracking.setPayment(freeOrder.getCpOrderId(), "zyxh", "CNY", freeOrder.getMoney());
                        }
                        break;
                }
            }
    ...
    public void pay(String json) {
        ...
        try {
            ...
            Tracking.setOrder(cpOrder, "CNY", money);
        } catch (JSONException e) {
    ...
    public void enterGame(String json) {
        ...
        Tracking.setEventJsonString("role", json);
    }
